...
headphones/earbuds. There's no acoustic echo cancellation here, so
occasionally a stray word from the other side can show up mislabeled on
your channel. Using headphones during the call minimizes this.
